...
export default function Page() {
  return (
    <main className="min-h-dvh flex items-center justify-center p-6">
      <section className="w-full max-w-xl rounded-lg border "   style={{ backgroundColor: '#9B8B6C' ,color: '#F4EEE1'}}>
        <div className="p-6 md:p-8">
          <header className="mb-6 text-center">
            <h1 className="text-2xl md:text-3xl font-semibold text-balance " style={{ color: '#F4EEE1' }}>Spojte se s námi – rychlý kontakt</h1>
            <p className="mt-2 text-muted-foreground text-pretty" style={{ color: '#F4EEE1' }}>
